...
- run `npm install https://github.com/GarryLaly/react-native-braintree-xplat.git`
...
1. Run `npm install https://github.com/GarryLaly/react-native-braintree-xplat.git --save`
